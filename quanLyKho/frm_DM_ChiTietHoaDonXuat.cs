...
namespace quanLyKho
{
    public partial class frm_DM_ChiTietHoaDonXuat : Form
    {
        ...
        private void dinhDangLuoi()
        {
            ...
            dgv_Main_DonXuat.Columns[0].Width = 170;
            dgv_Main_DonXuat.Columns[1].HeaderText = "Đơn vị tính";
            dgv_Main_DonXuat.Columns[1].Width = 170;
            dgv_Main_DonXuat.Columns[2].HeaderText = "Số lượng";
            dgv_Main_DonXuat.Columns[2].Width = 170;
            dgv_Main_DonXuat.Columns[3].HeaderText = "Đơn giá";
            dgv_Main_DonXuat.Columns[3].Width = 170;
        ...
        private void editPx()
        {
            try
            {
                string id = cbo_HangHoa.SelectedValue.ToString();
                object idKho = DataProvider.Instance.executeScalar("select id from kho  where idHangHoa = '" + id + "'");
                string query = "update chiTietPhieuXuat set  idKho = '" + Convert.ToInt32(idKho) + "', idPhieuXuat = '" + lbl_DM_CTPX_SoHoaDon.Text + "',soLuongXuat ='" + Convert.ToInt32(txt_SoLuong.Text.Trim()) + "', donGiaXuat = '" +Convert.ToInt32(txt_DonGia.Text) + "' where idXuat='" + idchitietphieuxuat() + "'";
                int i = DataProvider.Instance.executeNonQuery(query);
        ...
        public double getSoLuongXuat()
        {
            ...
            return Convert.ToDouble(soLuongXuat);
        }
        ...
        public double getThanhTien()
        {
            ...
            return Convert.ToDouble(getDonGia() * getSoLuong());
        }
        ...
        private void dgv_Main_DonXuat_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
        ...
        private void cbo_HangHoa_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            //txt_SoLuong.Text = getSoLuong().ToString();
